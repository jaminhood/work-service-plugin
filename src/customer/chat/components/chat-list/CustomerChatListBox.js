...
const CustomerChatListBox = ({ booking }) => {
 const { activeChat, handleActiveChat } = useCustomerContext()
 ...
 return (
  <div
   ...
   <div className="flex items-center justify-center w-12 h-12 overflow-hidden rounded-full bg-main-primary text-zinc-50">
    <span className="relative z-0 flex items-center justify-center w-12 h-12 p-2 overflow-hidden rounded-full">
...
export default CustomerChatListBox
