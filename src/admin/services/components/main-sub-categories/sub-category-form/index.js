...
const SubCategoryForm = ({ toggleOpen }) => {
 ...
 return (
  <Modal toggleOpen={toggleOpen} modalTitle="Add Sub Category" submit={handleSubmission}>
   <div className="grid grid-cols-1 gap-4">
    ...
    <div className="col-span-1">
     <select
      ...
      className="block w-full px-[1rem!important] py-[.5rem!important] text-sm border-[0!important] bg-zinc-50 focus:outline-[0] font-jost-regular placeholder:font-jost-regular">
      <option value="select" className="w-full">
       Select Category
      </option>
      {categories.map((category) => (
       <option value={category.category_id} selected={category.category_id === formCategory} key={category.category_id} className="w-full">
