...
const Modal = ({ toggleOpen, modalTitle, children, submit }) => {
 ...
 return (
  <motion.div className="fixed inset-0 z-50 flex items-center justify-center w-screen h-screen" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
   <div className="absolute inset-0 opacity-50 bg-main-primary -z-10 blur-sm" onClick={toggleOpen}></div>
