...
export const AdminRoutes = () => {
 ...
 if (typeof element !== "undefined" && element !== null) {
  ReactDOM.render(
   <OverviewPage />,
   document.getElementById("ws-admin-general-app"),
  )
 }
 ...
 if (typeof element !== "undefined" && element !== null) {
  ReactDOM.render(
   <ServicesPage />,
   document.getElementById("ws-admin-services-app"),
  )
 }
 ...
 if (typeof element !== "undefined" && element !== null) {
  ReactDOM.render(
   <OrdersPage />,
   document.getElementById("ws-admin-orders-app"),
  )
 }
 ...
 if (typeof element !== "undefined" && element !== null) {
  ReactDOM.render(
   <CustomersPage />,
   document.getElementById("ws-admin-customers-app"),
  )
 }
